...
<th {{ $attributes->merge(['class' => 'px-4 py-2.5 text-left text-[11px] font-bold text-white uppercase tracking-wide']) }}>
    <a href="{{ $href }}" class="inline-flex items-center gap-1 hover:text-blue-100 group">
        {{ $slot }}
