<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Uker / Cabang Baru</h2>
    </x-slot>
            ...
            <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                ...
                <form action="{{ route('ukers.store') }}" method="POST" class="space-y-4" x-data="{ kodeSpvTerpilih: '{{ old('kode_spv') }}' }">
                    ...
                    <div>
                        ...
                        <input type="number" name="kode" value="{{ old('kode') }}" class="mt-1 block w-full border-gray-300 rounded-md" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" value="{{ old('nama') }}" class="mt-1 block w-full border-gray-300 rounded-md" required>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="alamat" rows="3" class="mt-1 block w-full border-gray-300 rounded-md">{{ old('alamat') }}</textarea>
                    </div>
