            ...
            <x-card padding="p-6">
                ...
                <form action="{{ route('ukers.update', $uker) }}" method="POST" class="space-y-4" x-data="{ kodeSpvTerpilih: '{{ old('kode_spv', $uker->kode_spv) }}' }">
                    ...
                    <div>
                        ...
                        <input type="number" name="kode" value="{{ old('kode', $uker->kode) }}" readonly class="mt-1.5 block w-full border-gray-300 rounded-lg text-sm bg-gray-50 focus:border-cakrawala focus:ring-cakrawala" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" value="{{ old('nama', $uker->nama) }}" class="mt-1.5 block w-full border-gray-300 rounded-lg text-sm focus:border-cakrawala focus:ring-cakrawala" required>
                    </div>
