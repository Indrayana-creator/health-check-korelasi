            ...
            <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                ...
                >
                    ...
                    <div x-show="ukerKodeTerpilih" x-cloak>
                        ...
                        <p class="text-xs text-gray-400 mt-1">ID Aset (format Z5-K-uker-kode-urutan) akan digenerate otomatis setelah disimpan.</p>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700">Merek</label>
                        <input type="text" name="merek" value="{{ old('merek') }}" class="mt-1 block w-full border-gray-300 rounded-md" required>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700">Type</label>
                        <input type="text" name="tipe_model" value="{{ old('tipe_model') }}" class="mt-1 block w-full border-gray-300 rounded-md" required>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700">Serial Number (SN)</label>
                        <input type="text" name="sn" value="{{ old('sn') }}" class="mt-1 block w-full border-gray-300 rounded-md" required>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700">Kapasitas Memori (opsional)</label>
                        <input type="text" name="kapasitas_memori" value="{{ old('kapasitas_memori') }}" placeholder="contoh: 8GB" class="mt-1 block w-full border-gray-300 rounded-md">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700">Tahun Distribusi (opsional)</label>
                        <input type="number" name="tahun_perolehan" value="{{ old('tahun_perolehan') }}" min="2000" max="{{ date('Y') }}" class="mt-1 block w-full border-gray-300 rounded-md">
                    ...
                    <div class="border-t pt-4 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="pemegang_nama" value="{{ old('pemegang_nama') }}" class="mt-1 block w-full border-gray-300 rounded-md">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Jabatan</label>
                            <input type="text" name="jabatan" value="{{ old('jabatan') }}" class="mt-1 block w-full border-gray-300 rounded-md">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="ip_address" value="{{ old('ip_address') }}" class="mt-1 block w-full border-gray-300 rounded-md">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Status Hardening</label>
                            <input type="text" name="status_hardening" value="{{ old('status_hardening') }}" class="mt-1 block w-full border-gray-300 rounded-md">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Status Bitlocker</label>
                            <input type="text" name="status_bitlocker" value="{{ old('status_bitlocker') }}" class="mt-1 block w-full border-gray-300 rounded-md">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Status DLP</label>
                            <input type="text" name="status_dlp" value="{{ old('status_dlp') }}" class="mt-1 block w-full border-gray-300 rounded-md">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Status Antivirus</label>
                            <input type="text" name="status_antivirus" value="{{ old('status_antivirus') }}" class="mt-1 block w-full border-gray-300 rounded-md">
                        </div>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700">Keterangan (opsional)</label>
                        <textarea name="keterangan" class="mt-1 block w-full border-gray-300 rounded-md" rows="3" placeholder="contoh: Lantai 21">{{ old('keterangan') }}</textarea>
                    </div>
