            ...
            <x-card padding="p-6">
                ...
                >
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name', $user->name) }}" class="mt-1.5 block w-full border-gray-300 rounded-lg text-sm focus:border-cakrawala focus:ring-cakrawala" required>
                    </div>

                    <div>
                        <label class="block text-sm font-semibold text-gray-700">Email</label>
                        <input type="email" name="email" value="{{ old('email', $user->email) }}" class="mt-1.5 block w-full border-gray-300 rounded-lg text-sm focus:border-cakrawala focus:ring-cakrawala" required>
                    </div>

                    <div>
                        <label class="block text-sm font-semibold text-gray-700">PN (Personal Number, opsional)</label>
                        <input type="text" name="pn" value="{{ old('pn', $user->pn) }}" class="mt-1.5 block w-full border-gray-300 rounded-lg text-sm focus:border-cakrawala focus:ring-cakrawala">
                    ...
                    <div>
                        ...
                        <input type="password" name="password" placeholder="Kosongkan jika tidak ingin mengubah password" class="mt-1.5 block w-full border-gray-300 rounded-lg text-sm focus:border-cakrawala focus:ring-cakrawala">
                    </div>
