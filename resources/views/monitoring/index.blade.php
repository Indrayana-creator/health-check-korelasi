    ...
    <div class="p-7 space-y-4 max-w-[1360px]">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <x-card padding="p-5">
                ...
                <p class="text-[28px] font-extrabold text-gray-800 tracking-tight">{{ number_format($totalBermasalah, 0, ',', '.') }}</p>
            </x-card>
            <x-card padding="p-5" :class="$totalMendesak > 0 ? '!border-red-200' : ''">
                ...
                <p class="text-[28px] font-extrabold text-gray-800 tracking-tight">{{ number_format($totalMendesak, 0, ',', '.') }}</p>
            </x-card>
            <x-card padding="p-5">
