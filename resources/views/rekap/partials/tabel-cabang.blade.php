...
<div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
    <x-card padding="p-5">
        ...
        <p class="text-[28px] font-extrabold text-gray-800 tracking-tight">{{ $stat['total_cabang'] }}</p>
    </x-card>
    <x-card padding="p-5">
    ...
    <x-card padding="p-5">
        ...
        <p class="text-[28px] font-extrabold text-gray-800 tracking-tight">{{ $stat['total_perlu_perhatian'] }}</p>
    </x-card>
</div>
